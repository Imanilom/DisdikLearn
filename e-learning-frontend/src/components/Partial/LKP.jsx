...
const LKP = () => {
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      {/* Hero Section */}
      <section
        className="bg-blue-500 text-white py-40 md:py-60 bg-cover bg-center"
        style={{ backgroundImage: "url('../src/assets/hero-1.jpg')" }}
      >
        <div className="container mx-auto text-center px-4">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Selamat Datang di LMS LKP</h2>
          <p className="text-base md:text-lg mb-8">Platform Pembelajaran untuk Peningkatan Keterampilan dan Profesi</p>
        ...
        <div className="container mx-auto flex flex-col md:flex-row items-center gap-10 px-4">
          <div className="flex-1">
            <h3 className="text-2xl md:text-3xl font-bold text-left mb-6 relative">
              About LKP
              <motion.div
                className="absolute bottom-0 left-0 h-[4px] bg-lime-300"
                initial={{ width: 0 }}
                animate={{ width: '20%' }}
            ...
            <p className="text-base md:text-lg mb-6">
              LMS LKP adalah platform pembelajaran online yang dirancang khusus untuk mendukung pendidikan jarak jauh. Kami memberikan berbagai fitur pembelajaran yang membantu siswa dan guru untuk berinteraksi dan belajar dengan mudah.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10">
            ...
            >
              ...
              <h4 className="text-lg md:text-xl font-bold mb-4">( Digital Marketing)</h4>
            ...
            >
              ...
              <h4 className="text-lg md:text-xl font-bold mb-4">(Digital Printing)</h4>
              <p className="text-sm md:text-base mb-6">
            ...
            >
              ...
              <h4 className="text-lg md:text-xl font-bold mb-4">(Menjahit)</h4>
              <p className="text-sm md:text-base mb-6">
      ...
      <section id="about" className="py-16 bg-white">
        <div className="container mx-auto text-center px-4">
          <h3 className="text-2xl md:text-3xl font-bold -mb-10 text-left">Tentang Kami</h3>
        </div>
      </section>
