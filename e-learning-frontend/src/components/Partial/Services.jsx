...
const Service = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col items-center bg-white-100 py-10">
            <h1 className="text-4xl font-bold text-black-300 mb-4">Our Services</h1>
            <div className="w-16 border-t-2 border-gray-300 mb-6"></div>
            <div className="flex flex-wrap justify-center max-w-5xl mx-auto">
                {services.map((service, index) => (
                    ...
                    >
                        ...
                        />
                        <h2 className="text-xl font-semibold mb-2 text-center text-gray-400">{service.title}</h2>
            ...
            {user && (
                <div className="mt-8 text-center">
                    <button className="bg-blue-700 text-white px-6 py-3 rounded-full shadow-lg hover:bg-blue-300 transition-colors">
