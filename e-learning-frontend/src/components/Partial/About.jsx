...
const About = () => {
  ...
  const narratives = [
    {
      ...
      imgSrc: 'https://via.placeholder.com/800x600', // Replace with your image URL
    },
    {
      title: 'Our Vision',
  ...
  return (
    <section className="min-h-screen w-full bg-gray-100 flex items-center justify-center py-6">
